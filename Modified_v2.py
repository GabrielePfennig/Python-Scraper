...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 16:58:53 2023
...
for recipe_link in recipe_links:
    ...
    if response_recipe.status_code == 200:
        ...
        recipe_name = soup_recipe.find('h1')  # Hier die korrekte Klasse einfügen
...
# Definiere die Reihenfolge der Spalten in column_order
column_order = ['Recipe Name', 'Preptime', 'Difficulty', 'Calories', 'Rating Average', 'Rating Count', 'Recipe Servings', 'Quantity', 'Ingredients', 'Nutrition Values']

all_recipes_df.to_csv(csv_recipes, index=False, columns=column_order)

# Erfolgsmeldung ausgeben
print(f"Das DataFrame wurde erfolgreich in die CSV-Datei '{csv_recipes}' gespeichert.")
